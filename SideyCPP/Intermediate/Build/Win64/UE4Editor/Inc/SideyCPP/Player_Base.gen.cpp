...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_APlayer_Base_HitWall()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_APlayer_Base_HitWall_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
		static void NewProp_diving_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_diving;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_offsetSwingPoint_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_offsetSwingPoint;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APlayer_Base_Statics::NewProp_diving_MetaData[] = {
		{ "Category", "Player Movement" },
		{ "ModuleRelativePath", "Player_Base.h" },
	};
#endif
	void Z_Construct_UClass_APlayer_Base_Statics::NewProp_diving_SetBit(void* Obj)
	{
		((APlayer_Base*)Obj)->diving = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APlayer_Base_Statics::NewProp_diving = { UE4CodeGen_Private::EPropertyClass::Bool, "diving", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(APlayer_Base), &Z_Construct_UClass_APlayer_Base_Statics::NewProp_diving_SetBit, METADATA_PARAMS(Z_Construct_UClass_APlayer_Base_Statics::NewProp_diving_MetaData, ARRAY_COUNT(Z_Construct_UClass_APlayer_Base_Statics::NewProp_diving_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APlayer_Base_Statics::NewProp_offsetSwingPoint_MetaData[] = {
		{ "Category", "Player Movement" },
		{ "ModuleRelativePath", "Player_Base.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_APlayer_Base_Statics::NewProp_offsetSwingPoint = { UE4CodeGen_Private::EPropertyClass::Struct, "offsetSwingPoint", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(APlayer_Base, offsetSwingPoint), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_APlayer_Base_Statics::NewProp_offsetSwingPoint_MetaData, ARRAY_COUNT(Z_Construct_UClass_APlayer_Base_Statics::NewProp_offsetSwingPoint_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APlayer_Base_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APlayer_Base_Statics::NewProp_diving,
